  ...
  reg({
    ...
    steps: [
      { kind: 'teach', title: 'AND means between, OR means either',
        ...
        visual: '<svg viewBox="0 0 300 156" role="img" aria-label="AND is one band between two points; OR is two rays pointing apart"><text x="14" y="40" fill="var(--muted)" font-size="11.5" font-weight="700">AND</text><line x1="46" y1="52" x2="284" y2="52" stroke="var(--rule2)" stroke-width="2"/><line x1="100" y1="52" x2="226" y2="52" stroke="var(--m-accent)" stroke-width="5"/><circle cx="100" cy="52" r="6" fill="var(--panel)" stroke="var(--m-accent)" stroke-width="2.5"/><circle cx="226" cy="52" r="6" fill="var(--m-accent)"/><text x="163" y="38" fill="var(--m-accent)" font-size="11.5" font-weight="700" text-anchor="middle">between</text><text x="14" y="120" fill="var(--muted)" font-size="11.5" font-weight="700">OR</text><line x1="46" y1="120" x2="284" y2="120" stroke="var(--rule2)" stroke-width="2"/><line x1="46" y1="120" x2="100" y2="120" stroke="var(--m-good)" stroke-width="5"/><line x1="226" y1="120" x2="284" y2="120" stroke="var(--m-good)" stroke-width="5"/><polygon points="46,120 58,114 58,126" fill="var(--m-good)"/><polygon points="284,120 272,114 272,126" fill="var(--m-good)"/><circle cx="100" cy="120" r="6" fill="var(--m-good)"/><circle cx="226" cy="120" r="6" fill="var(--panel)" stroke="var(--m-good)" stroke-width="2.5"/><text x="163" y="106" fill="var(--m-good)" font-size="11.5" font-weight="700" text-anchor="middle">either side</text><text x="152" y="148" fill="var(--muted)" font-size="10.5" text-anchor="middle">○ open = not included    ● closed = included</text></svg>',
        moves: [
  ...
  reg({
    ...
    steps: [
      { kind: 'teach', title: 'The answer is a whole region, not a line',
        ...
        visual: '<svg viewBox="0 0 280 176" role="img" aria-label="The solution is a shaded half-plane on one side of a boundary line"><clipPath id="halfplane-clip"><rect x="20" y="14" width="240" height="148" rx="6"/></clipPath><rect x="20" y="14" width="240" height="148" fill="none" stroke="var(--rule)" stroke-width="1.5" rx="6"/><g clip-path="url(#halfplane-clip)"><polygon points="20,148 260,28 260,162 20,162" fill="var(--m-accent)" opacity="0.15"/><line x1="20" y1="148" x2="260" y2="28" stroke="var(--m-accent)" stroke-width="2.5"/></g><circle cx="150" cy="128" r="5" fill="var(--m-good)"/><text x="150" y="150" fill="var(--m-good)" font-size="11.5" font-weight="700" text-anchor="middle">test point makes it true → shade this side</text><text x="150" y="26" fill="var(--muted)" font-size="10.5" text-anchor="middle">the line is only the boundary</text></svg>',
        moves: [
